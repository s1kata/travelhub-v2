...
<head>
    ...
    <link rel="stylesheet" href="/frontend/css/pages/home.css?v=20">
        ...
        function loadMainFlightsForTours(hotels, callback) {
            ...
            if (typeof thLoadTourFlightsForHotels === 'function' && base) {
                thLoadTourFlightsForHotels(hotels, {
                    ...
                    maxTours: Math.min(hotels.length, 20),
                    maxConcurrent: 4,
                    patchEvery: 2,
                ...
                container.innerHTML = hotels.map(h => {
                    ...
                    return window.THTourCard.render(h, {
                        ...
                        flightMeta: (typeof thFlightsCacheGet === 'function' && tourId)
                            ...
                            : ((window.__mainFlightsByTourId && tourId) ? window.__mainFlightsByTourId[tourId] : null)
                    });
                }).join('');
