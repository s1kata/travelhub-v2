...
// Проверка реального MIME-типа (защита от подделки расширения)
...
// Уникальное имя — только наше расширение, без имени от клиента
$fileName = 'tour_' . time() . '_' . bin2hex(random_bytes(8)) . '.' . $extension;
