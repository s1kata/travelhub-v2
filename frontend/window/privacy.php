...
<section class="py-12 sm:py-16 bg-white">
    <div class="th-container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div class="content-section prose prose-lg max-w-none">
            ...
            <p>1.4. Размещая заявку, регистрируясь или иным образом предоставляя персональные данные через формы Сайта, пользователь подтверждает ознакомление с настоящей Политикой и даёт <a href="/frontend/window/consent.php">согласие на обработку персональных данных</a> (отдельный чекбокс в формах).</p>
            ...
            <p>2.2. Текст согласия размещён на странице <a href="/frontend/window/consent.php">Согласие на обработку персональных данных</a>.</p>

            <h2>3. Категории обрабатываемых данных</h2>
            <p>3.1. Через формы Сайта (заявки, бронирование, обратная связь, регистрация) Оператор, как правило, получает:</p>
            <ul>
                <li>ФИО;</li>
                <li>контактный телефон и (или) адрес электронной почты;</li>
                <li>город и иные сведения, которые пользователь добровольно указывает в комментарии/заявке;</li>
                <li>технические данные: IP-адрес, файлы cookie, сведения о браузере, устройстве и посещении страниц (в т. ч. при использовании Яндекс.Метрики — при согласии на аналитические cookies).</li>
            </ul>
            <p>3.2. Паспортные и иные данные, необходимые для оформления туристического продукта, обрабатываются только если пользователь сообщил их менеджеру или иным способом для исполнения договора — Сайт в типовых формах лидов такие данные не запрашивает.</p>
            <p>3.3. Специальные категории персональных данных и биометрия через Сайт не собираются.</p>
            ...
            <ul>
                ...
                <li>создание и обслуживание учётной записи (при регистрации);</li>
                <li>улучшение работы Сайта, аналитика посещаемости (в т. ч. Яндекс.Метрика — при согласии на cookies);</li>
            ...
            <p>Сайт использует необходимые cookies для работы форм и сессий, а также аналитические cookies (Яндекс.Метрика) после согласия пользователя через баннер на Сайте. Пользователь может отклонить аналитические cookies или ограничить cookies в настройках браузера; это может повлиять на статистику и отдельные функции.</p>
            ...
            <p>Сайт не предназначен для самостоятельного использования детьми младше 14 лет. Персональные данные несовершеннолетних обрабатываются только при предоставлении законным представителем в связи с оформлением туристических услуг.</p>

            <h2>11. Изменение Политики</h2>
            <p>Оператор вправе обновлять Политику. Новая редакция вступает в силу с момента публикации на Сайте. Актуальная версия всегда доступна на странице <a href="/frontend/window/privacy.php">Политика конфиденциальности</a>.</p>
